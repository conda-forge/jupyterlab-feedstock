...
pixi global install jupyterlab
```
...
It is possible to list all of the versions of `jupyterlab` available on your platform:
...
```
pixi search jupyterlab --channel conda-forge/label/jupyterlab_alpha
```
