...
Installing `jupyterlab` from the `conda-forge/label/jupyterlab_beta` channel can be achieved by adding `conda-forge/label/jupyterlab_beta` to your channels with:

```
conda config --add channels conda-forge/label/jupyterlab_beta
conda config --set channel_priority strict
```

Once the `conda-forge/label/jupyterlab_beta` channel has been enabled, `jupyterlab` can be installed with `conda`:
...
```
conda search jupyterlab --channel conda-forge/label/jupyterlab_beta
```

or with `mamba`:

```
mamba search jupyterlab --channel conda-forge/label/jupyterlab_beta
```
...
mamba repoquery search jupyterlab --channel conda-forge/label/jupyterlab_beta

# List packages depending on `jupyterlab`:
mamba repoquery whoneeds jupyterlab --channel conda-forge/label/jupyterlab_beta

# List dependencies of `jupyterlab`:
mamba repoquery depends jupyterlab --channel conda-forge/label/jupyterlab_beta
```
